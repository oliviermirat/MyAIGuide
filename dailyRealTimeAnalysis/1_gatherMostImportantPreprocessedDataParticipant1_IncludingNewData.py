...
# Getting data
inputt = open("../data/preprocessed/preprocessedDataParticipant1.txt", "rb") # From first research gate paper
data = pickle.load(inputt)
inputt.close()
print(data)

inputt = open('../data/preprocessed/swimmingStepsFromFitbit.pkl', "rb") # There might be some issues with this data
swimming_data = pickle.load(inputt)
inputt.close()

inputt = open('../data/preprocessed/cyclingStepsFromFitbit.pkl', "rb") # THERE ARE SOME ISSUES WITH THIS DATA, especially around early 2019!!!
