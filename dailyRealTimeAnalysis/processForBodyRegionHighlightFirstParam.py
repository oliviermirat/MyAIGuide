...
def processForBodyRegionHighlightFirstParam(data, region, stressor1, stressor2, stressor1_normalizationFactor, stressor2_normalizationFactor):
  ...
  # Plot
  hspace   = 0.4
  fig, axes = plt.subplots(figsize=(figWidth, figHeight), nrows=6, ncols=1)
  ...
  data[[stressor1 + "_RollingMean", region + "PainMeanAndNormalize"]].plot(ax=axes[5], color=["k", "r"])
  axes[5].title.set_fontsize(10)
  axes[5].title.set_text("summary firstParameter vs pain")
