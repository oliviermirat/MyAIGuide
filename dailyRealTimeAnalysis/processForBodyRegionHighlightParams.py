...
def processForBodyRegionHighlightParams(data, region, stressor1, stressor2, stressor1_normalizationFactor, stressor2_normalizationFactor, plotPain, lowerLimitDate='', compareBeforeAfterJan2024=False):
