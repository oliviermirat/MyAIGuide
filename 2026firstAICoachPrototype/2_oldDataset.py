"""
Same as 2_baseline.py but for the old dataset and pain types:
old_dataset, kneePain / foreheadEyesPain / fingerHandArmPain.
...
FILE_PATH = "oldDataset.txt"
STRESSOR_VARS_MINMAX_SCALER = 1
PAIN_REMOVE_OUTLIERS = 1
SPLIT_PERCENT_TRAINVAL_TEST = 0.75
SPLIT_PERCENT_TRAIN_VAL = 0.5

TEST_ON_VAL_DATASET = True
TRAINING_DATASET_BEFORE_TESTING = "train_val"

# Old dataset pain types (face = foreheadEyesPain, arm = fingerHandArmPain)
PAIN_TYPES = ["kneePain", "foreheadEyesPain", "fingerHandArmPain"]
...
def main() -> None:
    ...
    plot_compare_all_training_hyperparameters(
        knee_pain="kneePain",
        face_pain="foreheadEyesPain",
        arm_pain="fingerHandArmPain",
        run_paths=run_paths,
    )
    ...
    find_best_combination(
        kneePain="kneePain",
        facePain="foreheadEyesPain",
        armPain="fingerHandArmPain",
        candidates_config=candidates_config,
        run_paths=run_paths,
    )
