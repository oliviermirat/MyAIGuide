...
def combine_pdfs(dir_path, file1, file2, out_file):
    ...
    # Add (a) and (b) annotations higher up (Y=14 matches the 14pt font baseline)
...
if __name__ == "__main__":
    # Define paths and filenames using os.path.join to handle Windows/Mac/Linux slashes safely
    target_dir = os.path.join("results", "extendedTestSet_NoScaling", "bestHyperparametersSetResults")
    
    base_name_top = "trafficLights_kneePain"
    base_name_bot = "trafficLights_armPain"
    base_name_out = "trafficLights_kneePain_armPain_combined"
