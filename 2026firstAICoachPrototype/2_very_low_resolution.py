"""
Same as 2_baseline.py but for the Very Low Resolution stressors setup:
excludes some stressors, discretizes others to 0/1, binarizes climbingMaxEffortIntensity.
