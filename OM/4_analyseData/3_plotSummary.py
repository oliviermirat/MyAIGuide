...
if (0):
	...
	plotEnv([[21,'Road Bike Cal'],[13,'Alpi Ski Cal'],[15,'Climbing Cal'],
		[17,'Down Ski Cal'],[23,'Swimming Cal'],
		[25,'Via Ferrata Cal'],[27,'Walk Cal'],[19,'Mt Bike Cal']])

	plotEnv([[21+1,'Road Bike Step'],[13+1,'Alpi Ski Step'],[15+1,'Climbing Step'],
		[17+1,'Down Ski Step'],[23+1,'Swimming Step'],
		[25+1,'Via Ferrata Step'],[27+1,'Walk Step'],[19+1,'Mt Bike Step']])

	plotEnv([[5,'Road Bike Dur'],[1,'Alpi Ski Dur'],[2,'Climbing Dur'],
		[3,'Down Ski Dur'],[6,'Swimming Dur'],
		[7,'Via Ferrata Dur'],[8,'Walk Dur'],[4,'Mt Bike Dur']])
...
if (1):
	...
	plotEnv([[21,'Road Bike Cal'],[13,'Alpi Ski Cal'],[15,'Climbing Cal'],
		[17,'Down Ski Cal'],[23,'Swimming Cal'],
		[25,'Via Ferrata Cal'],[27,'Walk Cal'],[19,'Mt Bike Cal']],326)
