...
for num in numberlist:
    nbFiles = len(
        [
            ...
            if os.path.isfile(
                os.path.join("data/computerUsage/computer" + num + "/whatPulse/", name)
            )
        ]
    )
...
data["whatPulseKeysT"] = (
    data["whatPulseKeysC1"] + data["whatPulseKeysC2"] + data["whatPulseKeysC3"]
)
data["whatPulseClicksT"] = (
    data["whatPulseClicksC1"] + data["whatPulseClicksC2"] + data["whatPulseClicksC3"]
)
