...
# This script assumes that the dataframe has been created and saved in data.txt
...
rm = [
    'cum_gain_walking_RollingMean',
    'googlefitsteps_RollingMean',
    'oruxcumulatedelevationgain_RollingMean'
    'kneepain_RollingMean',
    'movessteps_RollingMean']
