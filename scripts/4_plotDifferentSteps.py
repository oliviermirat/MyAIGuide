...
# Creating the tracker_mean_steps variable in the dataframe and puts harmonized steps value inside
...
steps = selectColumns(data, ["steps", "movesSteps", "googlefitSteps", "basisPeakSteps", "tracker_mean_steps"])
fig, axes = plt.subplots(nrows=2, ncols=1)
steps.plot(ax=axes[0])
axes[0].legend(loc='center left', bbox_to_anchor=(1, 0.5))
selectColumns(data, ["tracker_mean_steps"]).plot(ax=axes[1])
