...
data["tracker_mean_steps"] = data["fitbitSteps"]
data = adjust_var_and_place_in_data(period1, data, "googlefitSteps", "basisPeakSteps", "tracker_mean_steps")
data = insert_data_to_tracker_mean_steps(period2, data, "basisPeakSteps", "tracker_mean_steps")
data = adjust_var_and_place_in_data(period3, data, "basisPeakSteps", "fitbitSteps", "tracker_mean_steps")
data = insert_data_to_tracker_mean_steps(period4, data, "fitbitSteps", "tracker_mean_steps")
data = adjust_var_and_place_in_data(period5, data, "movesSteps", "fitbitSteps", "tracker_mean_steps")
data = adjust_var_and_place_in_data(period6, data, "movesSteps", "fitbitSteps", "tracker_mean_steps")
data = adjust_var_and_place_in_data(period7, data, "googlefitSteps", "fitbitSteps", "tracker_mean_steps")
...
data = adjust_var_and_place_in_data(period5, data, "cum_gain", "fitbitFloors", "tracker_mean_denivelation")
data = adjust_var_and_place_in_data(period6, data, "elevation_gain", "fitbitFloors", "tracker_mean_denivelation")
data = adjust_var_and_place_in_data(period7, data, "elevation_gain", "fitbitFloors", "tracker_mean_denivelation")
...
# Steps
data[["fitbitSteps", "movesSteps", "googlefitSteps", "basisPeakSteps", "tracker_mean_steps"]].plot(ax=axes[0])
axes[0].legend(loc='center left', bbox_to_anchor=(1, 0.5))
# Cumulated elevation gain
data[["cum_gain", "elevation_gain", "fitbitFloors", "tracker_mean_denivelation"]].plot(ax=axes[1])
...
# Time spent driving
data["timeDrivingCar"].plot(ax=axes[3])
axes[3].legend(loc='center left', bbox_to_anchor=(1, 0.5))
# Mental state
data["generalmood"].plot(ax=axes[4])
axes[4].legend(loc='center left', bbox_to_anchor=(1, 0.5))
# Maximum pain in other regions
data["maxPainOtherThanKnee"].plot(ax=axes[5])
axes[5].legend(loc='center left', bbox_to_anchor=(1, 0.5))
# Knee pain
data["kneePain"].plot(ax=axes[6])
axes[6].legend(loc='center left', bbox_to_anchor=(1, 0.5))
