...
period7 = ("2018-07-31", "2022-03-26")  # fitbit and googlefit
period7b = ("2018-07-31", "2020-02-01") # fitbit and googlefit (for denivelation)
period7c = ("2020-02-02", "2022-03-26") # fitbit (for denivelation); TODO: ADD DENIVELATION HERE, NEED TO RERUN THE GOOGLE MAP API TO CALCULATE DENIVELATION ON DATA FROM GOOGLEFIT
...
data = data.loc[data.index <= "2022-03-26"]
