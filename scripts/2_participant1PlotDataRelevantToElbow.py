...
data["maxPainOtherThanForearmElbow"] = data[["kneePain", "foreheadAndEyesPain", "handsAndFingerPain", "aroundEyesPain", "shoulderNeckPain", "sick_tired", "painInOtherRegion"]].max(axis=1)
...
data["maxPainOtherThanForearmElbow"].plot(ax=axes[4])
axes[4].legend(loc='center left', bbox_to_anchor=(1, 0.5))
# Forearm and Elbow pain
data["forearmElbowPain"].plot(ax=axes[5])
